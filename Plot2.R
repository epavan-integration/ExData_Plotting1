...
hist(as.numeric(power_data$Global_active_power)/1000, col = "orangered2", xlab = "Global Active Power (kilowatts)" ,main = "Global Active Power", breaks = 12, ylim = c(0,1200), xlim=c(0,6))
dev.off()
